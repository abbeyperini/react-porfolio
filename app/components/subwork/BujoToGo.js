    ...
    return (
        <div id="BujoToGo" className="subWork">
            ...
            <span className="subwork_links">
                <a href="https://github.com/abbeyperini/BujoToGo" target="_blank" rel="noreferrer"><img src={Github} className="work_icon"/></a>
                <a href="http://bujo-to-go.surge.sh/#/index" target="_blank" rel="noreferrer"><img src={Chrome} className="work_icon"/></a>
            </span>
        </div>
    )
}
